"""v12: 经典双动量 (Dual Momentum)
=====================================
双动量策略核心:
  1. 时序动量 (Time Series): 12月动量 > 0 (只买上涨趋势)
  2. 截面动量 (Cross-Sectional): 取动量最高的Top 3
...
print("v12: 经典双动量 | 12月动量>0 | Top3 | 15%止损 | 月度调仓")
print("=" * 80)
...
print(f"\n\n{'指标':<20} {'v12 双动量':>15} {'v10c':>15} {'沪深300':>15}")
print("=" * 75)
...
results.to_csv(os.path.join(CACHE_DIR, '..', 'backtest_v12.csv'), index=False)
