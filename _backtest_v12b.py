...
print("v12b: 短端双动量 | 60日动量>0 + 价格>MA20 | Top3 | 15%止损 | 月度")
print("=" * 80)
...
for i, date in enumerate(dates):
    ...
    if is_first_trading(date) and i >= 100:
        ...
        for code in sector_codes:
            ...
            if mom is not None and mom > 0 and is_trend_up(code, date, MA_TREND):
...
print(f"\n\n{'指标':<20} {'v12b 短端':>15} {'v10c':>15} {'沪深300':>15}")
print("=" * 80)
...
results.to_csv(os.path.join(CACHE_DIR, '..', 'backtest_v12b.csv'), index=False)
